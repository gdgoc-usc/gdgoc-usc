...
const TeamMemberSkeleton: React.FC<TeamMemberSkeletonProps> = ({
  ...
  return (
    ...
    >
      <div className='w-full aspect-[3/4] relative bg-gradient-to-br from-gray-200 via-gray-300 to-gray-400 dark:from-gray-600 dark:via-gray-700 dark:to-gray-800 overflow-hidden'>
