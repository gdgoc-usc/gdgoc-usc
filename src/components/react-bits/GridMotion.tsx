...
const GridMotion: FC<GridMotionProps> = ({
  ...
  useEffect(() => {
    ...
    const updateMotion = (): void => {
      ...
      const autoScrollX = Math.sin(autoScrollRef.current * 0.01) * window.innerWidth * 0.3;
      ...
      rowRefs.current.forEach((row, index) => {
        if (row) {
          ...
          const mouseInfluence = (mouseXRef.current / window.innerWidth) * maxMoveAmount - maxMoveAmount / 2;
