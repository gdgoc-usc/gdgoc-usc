    ...
    >
      ...
      <img
        ...
        style={{
          filter: `
            ...
            brightness(${isHovered ? '70%' : '90%'}) 
            sepia(${isHovered ? '30%' : '40%'}) 
        ...
        style={{
          background: `
            repeating-conic-gradient(from 0deg at 50% 50%, 
              ...
              transparent 45deg, 
              rgba(52, 168, 83, 0.3) 90deg, 
              transparent 135deg,
              rgba(251, 188, 4, 0.3) 180deg,
              transparent 225deg,
              rgba(234, 67, 53, 0.3) 270deg,
              transparent 315deg
            ),
      ...
      <div 
        className={`absolute inset-0 mix-blend-multiply transition-all duration-700 ease-out ${
          isHovered ? 'opacity-0 scale-105' : 'opacity-50 scale-100'
        }`}
        style={{
          background: `
        ...
        style={{
          background: `
            repeating-linear-gradient(
              ...
              rgba(66, 133, 244, 0.3) 2px,
              transparent 2px,
              transparent 4px,
              rgba(52, 168, 83, 0.3) 4px,
              rgba(52, 168, 83, 0.3) 6px,
              transparent 6px,
              transparent 8px
            ),
            repeating-linear-gradient(
              90deg,
              rgba(251, 188, 4, 0.3) 0px,
              rgba(251, 188, 4, 0.3) 2px,
              transparent 2px,
              transparent 4px,
              rgba(234, 67, 53, 0.3) 4px,
              rgba(234, 67, 53, 0.3) 6px,
              transparent 6px,
              transparent 8px
            )
          `,
